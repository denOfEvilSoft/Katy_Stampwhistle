...
namespace Katy_Stampwhistle
{
    partial class Help
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "케이티 스탬프휘슬은 이메일 대량 전송 프로그램입니다.\r\n엄청난 수의 사람들에게 같은 첨부파일, 같은 제목, 같은 내용의 이메일을 간편하게 전송할 " +
    "수 있지요!";
            // 
            // label2
            // 
            ...
            this.label2.Text = "시작 전에 이메일을 보낼 계정의 설정을 바꿔주어야 해요!\r\n이메일을 보낼 구글 계정이 2차 인증 (폰인증) 같은것이 걸려있다면 사용전, 모두 풀어" +
    "주세요";
            // 
            // label3
            // 
            ...
            this.label3.Text = "그 후 보안 탭으로 이동하고, 보안 수준이 낮은 앱의 액세스를 \"사용\"으로 바꿔주세요";
            // 
            // label4
            // 
            ...
            this.label4.Text = "케이티 스탬프휘슬 : 이메일 대량 전송기";
            // 
            // panel1
            // 
            ...
            this.label6.Location = new System.Drawing.Point(547, 8);
